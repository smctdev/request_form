...
const EditStockModalSuccess = ({ closeSuccessModal, refreshData }: { closeSuccessModal: () => void; refreshData: () => void; }) => {
...
return (
    ...
    <div className="fixed z-50 top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50 flex-col ">
    ...
    <p className='my-7  text-gray-400 font-semibold text-center'>Request Edited!</p>
   
    </div>
    <div className='bg-graybg w-full rounded-b-lg flex justify-center items-center p-4'>
    <button className=' bg-primary p-2 w-1/2 rounded-[12px] text-white font-extrabold' onClick={() => { closeSuccessModal(); refreshData(); }}>OKAY</button>
