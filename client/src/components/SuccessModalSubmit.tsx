...
const SuccessModalSubmit = ({ showSuccessModal, closeSuccessModal, openSuccessModal, entityType }: { showSuccessModal: boolean, closeSuccessModal: any, openSuccessModal: any, entityType:string }) => {
    if (!showSuccessModal) {
        return null;
      }
